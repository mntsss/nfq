...
<head>
    ...
    <title>GT Coilovers | Racing </title>
...
<body>
    <nav class="navbar navbar-expand to navbar-toggleable-xl navbar-dark bg-dark mb-5">
            ...
            <span class="ml-4 d-none d-sm-block">
                ...
                <span class="h5 text-light">Tuning</span>
            </span>
            <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarMeniu" aria-controls="navbarText" aria-expanded="false" aria-label="Toggle navigation">
                <span class="navbar-toggler-icon"></span>
            </button>

            <div class="collapse navbar-collapse flex-row float-right" id="navbarMeniu">
